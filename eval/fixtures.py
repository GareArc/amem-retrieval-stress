...
NOISE_MEMORIES: list[dict[str, Any]] = [{'id': 'noise_01',
 ...
 {'id': 'noise_07',
  ...
  'keywords': ['New', 'Haven', 'Connecticut', 'January'],
  'context': 'General information about the topic',
  'tags': ['general']},
 {'id': 'noise_08',
  'content': 'Antarctic krill biomass is estimated at around 379 million tonnes, making it one of the most abundant '
             'species',
  'keywords': ['Antarctic', 'species'],
  'context': 'General information about nature',
  'tags': ['nature']},
 {'id': 'noise_09',
  'content': 'Regular exercise reduces the risk of cardiovascular disease by improving blood circulation and lowering '
             'cholesterol',
  'keywords': ['Regular', 'disease'],
  'context': 'General information about health',
  'tags': ['health']},
 {'id': 'noise_10',
  'content': 'The Gutenberg printing press, invented around 1440, revolutionized the spread of written knowledge '
             'across Europe',
  'keywords': ['Gutenberg', 'Europe'],
  'context': 'General information about the topic',
  'tags': ['general']},
 {'id': 'noise_11',
 ...
 {'id': 'noise_13',
  ...
  'tags': ['general']},
 {'id': 'noise_14',
  'content': "The human brain consumes roughly 20 percent of the body's total energy despite being only 2 percent of "
             'body weight',
  'keywords': ['ai'],
  'context': 'General information about technology',
  'tags': ['technology']},
 {'id': 'noise_15',
  'content': 'Container shipping handles over 80 percent of global trade by volume through standardized intermodal '
             'containers',
  'keywords': ['Container', 'ai'],
  'context': 'General information about technology',
  'tags': ['technology']},
 {'id': 'noise_16',
 ...
 {'id': 'noise_17',
  ...
  'keywords': ['Renaissance', 'Florence', 'Medici', 'ai'],
  'context': 'General information about technology',
  'tags': ['technology']},
 {'id': 'noise_18',
  'content': 'Coral reefs support approximately 25 percent of all marine species despite covering less than one '
             'percent of the ocean floor',
  'keywords': ['Coral', 'ocean', 'species'],
  'context': 'General information about nature',
  'tags': ['nature']},
 {'id': 'noise_19',
  'content': 'The Trans-Siberian Railway spans 9,289 kilometers from Moscow to Vladivostok across seven time zones',
  'keywords': ['Trans', 'Siberian', 'Railway', 'Moscow', 'Vladivostok'],
  'context': 'General information about technology',
  'tags': ['technology']},
 {'id': 'noise_20',
  'content': 'Honeybees communicate the location of food sources through a series of movements known as the waggle '
             'dance',
  'keywords': ['Honeybees'],
  'context': 'General information about the topic',
  'tags': ['general']}]
